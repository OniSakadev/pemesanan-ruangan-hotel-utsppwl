...
use App\Http\Controllers\User\UserKamarController;
...
Route::middleware(['auth', 'adminMiddleware'])->prefix('admin')->group(function () {
    ...
    // Kelola Pesanan
    Route::get('/pesanan', [AdminPemesananController::class, 'index'])->name('admin.pemesanan.index');
    Route::post('/pesanan/{id}/konfirmasi', [AdminPemesananController::class, 'konfirmasi'])->name('admin.pemesanan.konfirmasi');
    Route::post('/pesanan/{id}/batal', [AdminPemesananController::class, 'batalkan'])->name('admin.pemesanan.batalkan');

    // Kelola User
    Route::get('/users', [AdminUserController::class, 'index'])->name('admin.users.index');
    Route::put('/users/{id}/update-role', [AdminUserController::class, 'updateRole'])->name('admin.users.updateRole');
});
